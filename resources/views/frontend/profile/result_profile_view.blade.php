     ...
     <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body">
                    <h4 class="card-title">Attempt: {{ $loop->iteration }}</h4>
                    <hr>
                    <h4 class="card-title">Correct: {{ $serve->correctans }}</h4>
                    <hr>
                    <h4 class="card-title">In-Correct:{{ $serve->wrongans }} </h4>
                    <hr>
                    <h4 class="card-title">Result:{{ $serve->correctans}}/5 </h4>
                    <hr>
                    
                    <a href="{{route('delete_result',$serve->id)}}" class="btn btn-danger btn-rounded waves-effect waves-light">Delete Result</a>
                    </div>
                </div>
