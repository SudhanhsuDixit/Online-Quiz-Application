        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                <div class="card"><br><br>
                    <center>        
                        <img class="round-circle avatar-xl" src="{{ (!empty($userData->photo))?  url('upload/user_images/'.$userData->photo):url('upload/no_image.jpg') }}" alt="Card image cap">
                    </center>   
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('edit.user_profile')}}" class="btn btn-info btn-rounded waves-effect waves-light custom-margin">Edit Profile</a>

                    <a href="{{route('show_result')}}" class="btn btn-primary btn-rounded waves-effect waves-light custom-margin">Quiz Result</a>
                    <a href="{{route('change.userpassword')}}" class="btn btn-info btn-rounded waves-effect waves-light custom-margin">Update Password</a>
                    </div>
                </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('frontend/assets/img/course-1.jpg') }}" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('frontend/assets/img/course-2.jpg') }}" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('frontend/assets/img/course-3.jpg') }}" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('frontend/assets/img/course-2.jpg') }}" alt="">
                        </div>
