    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="testimonial_image" class="form-control" type="file" value="{{ $testimonial->testimonial_image }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="profession" class="form-control" type="text" value="{{ $testimonial->profession }}" id="example-text-input">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="description" class="form-control" type="text" value="{{ $testimonial->description }}" id="example-text-input">
                </div>
            </div>
            <!-- end row -->
