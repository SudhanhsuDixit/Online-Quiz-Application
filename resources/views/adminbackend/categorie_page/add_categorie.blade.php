    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="categorie_image" class="form-control" type="file" id="example-text-input">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="col_name" class="form-control" type="text"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="course_no" class="form-control" type="text"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
